...
public class FPP_1102_verifyPricerPortal_GlobalNavigationSidebar extends AUTBaseTest  implements ObjectRepository {
	/* Description:
	 * To verify that pricing manager can login and select a page to navigate on the Global Navigation Sidebar.
	 * 
	 * Role: Pricing Manager
	 * 
	 */
	
	@DataProvider(name = "FPP_1102")
	public Object[][] dt() throws Exception
	{
		Object[][] data = getTableArray(Directory.dataSheetPath, "FPP_1102", "jData");
		return(data);
	}
	
	@Test (dataProvider = "FPP_1102")
	...
	try {
		...
		//Verifying Pricer functionalities in Global Side bar Navigation
