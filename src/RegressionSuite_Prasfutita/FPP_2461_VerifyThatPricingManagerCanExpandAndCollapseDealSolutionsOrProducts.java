...
public class FPP_2461_VerifyThatPricingManagerCanExpandAndCollapseDealSolutionsOrProducts extends AUTBaseTest {
	...
	public void test(String browser, String url, String userId, String password, String dealName)
	{
		...
		try
		{
			...
			objFPPPricingManagerDealPortalPage.verifyExpandCollapseSolution();
