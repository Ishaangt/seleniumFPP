...
public class FPPPricingManagerPreviewDeal extends AUTBaseTest {
	...
	public void verifyAllLable()
	{
		try
		{
			...
			if(isElementPresent(DealPreview.lblTVC,DealPreview.lblTVCBy))
			...
			if(isElementPresent(DealPreview.lblOnVoiceCredit,DealPreview.lblOnVoiceCreditBy))
			...
			if(isElementPresent(DealPreview.lblOn_offCharges,DealPreview.lblOn_offChargesBy))
